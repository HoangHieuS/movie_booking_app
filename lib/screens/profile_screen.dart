...
class _ProfileScreenState extends State<ProfileScreen>
  ...
  void initState() {
    ...
    _animationImage = Tween<Offset>(
      begin: Offset.zero,
      end: const Offset(0.0, -0.4),
    ).animate(_animationController);
    _animationCamera = Tween<Offset>(
      begin: Offset.zero,
  ...
  Widget build(BuildContext context) {
    SystemChrome.setSystemUIOverlayStyle(
        const SystemUiOverlayStyle(statusBarColor: ThemeColor.appBarColor));
    String? imgUrl = AuthController.instance.user!.photoURL;
    imgUrl = imgUrl ?? Constants.dummyAvatar;
    String? name = AuthController.instance.user!.displayName ?? "Unknown";
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _CustomTextForm(
                      ...
                      iconBackground: const Color(0xFFCCEFE0),
                      iconColor: const Color(0xFF48EB9F),
                    ),
                    const Divider(
                      thickness: 1,
